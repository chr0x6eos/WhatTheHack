        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('challenges.store') }}" id="challengeform">
                    ...
                    <div class="form-group row">
                        <label for="attachments" class="col-sm-4 col-form-label text-md-right">
                            {{ __('Attachments (optional):') }}
                        </label>
                        <div class="col-md-6">
                            <input id="attachments" type="text" class="form-control" name="attachments" required autofocus>
                        </div>
                    </div>
